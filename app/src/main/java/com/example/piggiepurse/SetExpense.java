...
public class SetExpense extends AppCompatActivity {
    EditText inputExpense, expenseDescription;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.set_expense);
        ...
        //action for select expense category
        categorySelectArea.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ExpenseCategory.class);
        ...
        dateSelectArea.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(SetExpense.this,android.R.style.Theme_Holo_Light_Dialog_MinWidth, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        timeSelectArea.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(SetExpense.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    float floatAmount = Float.parseFloat(inputExpense.getText().toString());
                    ...
                    if (checkInsertData) {
                        Toast.makeText(SetExpense.this, "New expense record inserted successfully.", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(SetExpense.this, "Expense record not inserted.", Toast.LENGTH_SHORT).show();

                    }

                } catch (NumberFormatException e) {
                    Toast.makeText(SetExpense.this, "Invalid amount. Please enter a valid number.", Toast.LENGTH_SHORT).show();

                } catch (IllegalArgumentException e) {
                    Toast.makeText(SetExpense.this, e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == Activity.RESULT_OK && data != null) {
            //check if result is from ExpenseCategory activity
